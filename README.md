# Rho-Bank A2A Hackathon

> **Primary track: [A2A Interoperability](https://github.com/a2anet/a2a-hackathon-template)** — see **[A2A.md](A2A.md)** for the dev loop (`docker compose up` + `a2a-hack smoke`).  
> This repo also retains the CopilotKit **Generative UI** starter below as optional Track 2 scaffolding.
